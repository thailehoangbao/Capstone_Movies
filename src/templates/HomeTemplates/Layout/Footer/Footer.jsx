...
export default function Footer() {
    ...
    const { heThongRapPhim } = useSelector(state => state.QuanLyHeThongRapReducer)
            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <img src="https://printgo.vn/uploads/file-logo/1/512x512.22cdafa36d7ed05664bdb0a0699771c2.ai.1.png" alt="cgv" width={100} height={64} />
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracki uppercase dark:text-gray-50 text-center">PARTNER</h3>
                        <div className="space-y-1 grid grid-cols-3 gap-1">
                            {arrHeThongRapPhim.map((heThongRap, index) => {
                                return (
                                    <div key={index} className='flex justify-center align-middle'>
                                        <img src={heThongRap.logo} width={30} alt={heThongRap.tenHeThongRap} />
                                    </div>
                                )
                            })}
                        </div>
