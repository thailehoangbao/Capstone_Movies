...
import { layHeThongRapAction } from '../../redux/actions/QuanLyHeThongRapAction';
...
export default function Home(props) {
    ...
    useEffect(() => {
        ...
        dispatch(action);// dispatch funct từ redux-thunk
    ...
    return (
        <div>
            ...
            <div className='container px-5'>
                <HomeMenu heThongRapPhim={heThongRapPhim} />
            </div>
        </div>
    )
}
